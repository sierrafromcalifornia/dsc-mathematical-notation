...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE\displaystyle\sum_{n=1}^{5}x">
...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE\displaystyle\sum_{n=1}^{5}x=1%2b2%2b3%2b4%2b5">
...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE\displaystyle\sum_{n=1}^{5}x^2-2">

Which, if "unrolled" to show each step, would look like: 

<img src="https://render.githubusercontent.com/render/math?math=\LARGE\displaystyle\sum_{n=1}^{5}x^2-2 =(1^2 - 2)%2b(2^2 - 2)%2b(3^2 - 2)%2b(4^2 - 2)%2b(5^2 - 2)">
...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE \displaystyle\sum_{i=1}^{w} w_i x_i">
...
<img src="https://render.githubusercontent.com/render/math?math=\LARGE\displaystyle\prod_{i=1}^{5} i %2b 2">

Which, when written out completely, would be:

<img src="https://render.githubusercontent.com/render/math?math=\LARGE \displaystyle\prod_{i=1}^{5} i %2b 2 = (1 %2b 2) * (2 %2b 2) * (3 %2b 2) * ( 4 %2b 2) * ( 5 %2b 2)">
